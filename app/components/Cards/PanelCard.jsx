...
import panelCardStyle from "assets/jss/material-dashboard-pro-react/components/panelCardStyle";
...
class ChartCard extends React.Component {
  ...
  render() {
    ...
    if (hover) {
      ...
      addClickEvent.onClick= () => onClick();
    }
    return (
      <Card className={classes.card} {...addHoverEvent} {...addClickEvent}>
        <CardHeader className={cardHeaderClasses} subheader={chart} classes={{subheader: classes.cardSubheader}} />
...
export default withStyles(panelCardStyle)(ChartCard);
