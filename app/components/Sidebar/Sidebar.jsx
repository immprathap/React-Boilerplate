                  ...
                  <List className={classes.list + " " + classes.collapseList}>
                    {prop.views.map((childProp, key) => {
                      ...
                      const navLinkClasses =
                        ...
                        " " +
                        cx({
                          [" " + classes[color]]: this.activeRoute(childProp.path)
                        });
                      const collapseItemMini =
                        classes.collapseItemMini +
                        " " +
                      ...
                      return (
                        <ListItem key={key} className={classes.collapseItem}>
                          <NavLink to={prop.path+childProp.path} className={navLinkClasses}>
                            <span className={collapseItemMini}>
                              {childProp.mini}
                            </span>
                            <ListItemText
                              primary={childProp.name}
                              disableTypography={true}
                              className={collapseItemText}
                            />
                          </NavLink>
    ...
    var brand = (
      <div className={logoClasses}>
        ...
        <a href="/" className={logoNormal}>
          {/*logoText*/}
          <img src={logoText} alt="brand" className={classes.brandImg} />
        </a>
      </div>
    );
    const drawerPaper =
